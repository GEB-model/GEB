# dev
- Write new model version after each version update in `geb update-version`. This way, when the model is updated multiple versions ahead, and one of the updates failes, the version updates that succeeded are still "saved".
