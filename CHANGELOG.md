...
- Fix bug where river widths could be negative in rare cases. This led to a clear raised error in the model run, so it doesn't affect any model than ran normally ([#770](https://github.com/GEB-model/GEB/issues/770))
