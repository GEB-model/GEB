...
class Government(AgentBaseClass):
    ...
    def provide_subsidies(self) -> None:
        ...
        n_farmers_to_upgrade = int(self.agents.farmers.n * self.ratio_farmers_to_provide_subsidies)
    ...
    def step(self) -> None:
        ...
        if self.model.args.scenario == 'government_subsidies' and self.model.current_time.day == 1 and self.model.current_time.month == 1 and self.model.current_timestep != 0:
