...
class CWatM_Model(CWATModel):
    ...
    def __init__(self, start_time: datetime.datetime, n_steps: int, settings: str) -> None:
        ...
        binding["chanMan"] = os.path.join(INPUT, "maps", "grid", "mannings.tif")
        binding["chanLength"] = os.path.join(INPUT, "maps", "grid", "channel_length.tif")
        binding["chanWidth"] = os.path.join(INPUT, "maps", "grid", "channel_width.tif")
        binding["chanDepth"] = os.path.join(INPUT, "maps", "grid", "channel_depth.tif")
        binding["chanRatio"] = os.path.join(INPUT, "maps", "grid", "channel_ratio.tif")
        binding["chanGrad"] = os.path.join(INPUT, "maps", "grid", "channel_slope.tif")
