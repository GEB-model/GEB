...
3. Update the [version_updates](https://github.com/GEB-model/GEB/blob/main/geb/build/version_updates.py), setting the latest entry to the version you will release when required.
