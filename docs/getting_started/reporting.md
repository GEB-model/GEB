...
Water circles are used to report the inflow and outflow of water in the system. These can be generated by `geb evaluate --method hydrology.water_circle`, but require special variables to be reported during the run.
