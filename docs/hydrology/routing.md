...
The river network topology is derived from a Local Drain Direction (LDD) map using the [pyflwdir](https://deltares.github.io/pyflwdir/) package, which allows for efficient traversals and upscaling.
