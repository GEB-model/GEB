...
Next download, `30sec_basids.tif`, `30sec_elevtn.tif`, `30sec_uparea.tif`, `30sec_rivlen_ds.tif`, `30sec_rivslp.tif` and `30sec_flwdir.tif` from `Zenodo <https://zenodo.org/record/5166932>`_ and place in `DataDrive/GEB/original_data/merit_hydro_30sec`. Now run `preprocessing.1_create_mask_and_hydro_maps.py` to create the mask, submask and several hydrological maps.
