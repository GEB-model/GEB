...
The command areas are obtained from the `India Water Resources Information System <https://gis.indiawris.gov.in/server/rest/services/SubInfoSysLCC/WRP_Old/MapServer/7/>`_. The API can be queried in various ways. Here, we manually collected a list of all IDs of the command areas through the API, and then download all files using an automated script.
