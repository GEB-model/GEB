"""Utilities to download and setup damage model."""
...
class GlobalDamageModel(Adapter):
    ...
    def fetch(self, url: str) -> GlobalDamageModel:
        """Fetch the damage functions file from the specified URL and save it to the local path if it doesn't already exist.

        Returns:
            The GlobalDamageModel instance with the damage functions file downloaded and saved locally.
        """
