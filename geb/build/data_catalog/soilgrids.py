...
class SoilGridsV2(Adapter):
    ...
    def fetch(self, url: str) -> SoilGridsV2:
...
class SoilGridsV1(Adapter):
    """SoilGrids 2017 data catalog adapter."""

    def __init__(self, *args: Any, **kwargs: Any) -> None:
        """Initialize the SoilGrids adapter."""
        super().__init__(*args, **kwargs)

    def fetch(self, url: str) -> SoilGridsV1:
        """Sets the SoilGrids dataset from the specified URL.
    ...
    def read(self, variable: str, **kwargs: Any) -> xr.DataArray:
        """Read the SoilGrids data for the specified variable and depth.
