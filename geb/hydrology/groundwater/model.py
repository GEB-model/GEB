...
class ModFlowSimulation:
    ...
    def get_simulation(
        ...
        flopy.mf6.ModflowGwfdisv(
            ...
            vertices=vertices,
            cell2d=cell2d,
            top=self.hydrology.data.grid.decompress(
                self.layer_boundary_elevation[0]
            ).tolist(),
            botm=self.hydrology.data.grid.decompress(
        ...
        # Node property flow
        k = self.hydrology.data.grid.decompress(hydraulic_conductivity)
        ...
        sy = self.hydrology.data.grid.decompress(specific_yield)
        ss = self.hydrology.data.grid.decompress(specific_storage)
