...
class ModFlowSimulation:
    ...
    def get_simulation(
        ...
        flopy.mf6.ModflowGwfdisv(
            ...
            vertices=vertices,
            cell2d=cell2d,
            top=self.hydrology.grid.decompress(
                self.layer_boundary_elevation[0]
            ).tolist(),
            botm=self.hydrology.grid.decompress(
        ...
        # Node property flow
        k = self.hydrology.grid.decompress(hydraulic_conductivity)
        ...
        sy = self.hydrology.grid.decompress(specific_yield)
        ss = self.hydrology.grid.decompress(specific_storage)
