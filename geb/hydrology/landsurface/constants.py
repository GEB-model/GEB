...
# Aliases used by energy.py and redistribution.py
L_FUSION_J_PER_KG: np.float32 = LATENT_HEAT_FUSION_J_PER_KG
LATENT_HEAT_VAPORIZATION_J_PER_KG: np.float32 = np.float32(2.501e6)
L_VAPORIZATION_J_PER_KG: np.float32 = LATENT_HEAT_VAPORIZATION_J_PER_KG
LATENT_HEAT_SUBLIMATION_J_PER_KG: np.float32 = np.float32(2.834e6)
L_SUBLIMATION_J_PER_KG: np.float32 = LATENT_HEAT_SUBLIMATION_J_PER_KG
