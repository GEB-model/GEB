...
class KinematicWave(Router):
    ...
    def calculate_discharge_from_river_storage(
        ...
        discharge: ArrayFloat32 = (cross_sectional_area_of_flow / river_alpha) ** (
            1 / river_beta
        )
    ...
    def get_available_storage(
        ...
        """
        return (
            self.get_total_storage(Q, river_alpha, river_beta)
    ...
    def _step(
        ...
        Args:
            ...
            river_beta: The beta parameter for the kinematic wave equation, which is a 1D array.
...
class Accuflux(Router):
    ...
    def get_available_storage(
        ...
        Args:
            Q: The discharge in each cell, in m3/s.
            river_alpha: The alpha parameter for the kinematic wave equation. Not used in this method, but included for consistency with the KinematicWave class.
            river_beta: The beta parameter for the kinematic wave equation. Not used in this method, but included for consistency with the KinematicWave class.
    ...
    def calculate_river_storage_from_discharge(
        ...
        Args:
            discharge: The discharge in each cell, in m3/s.
            river_alpha: Unused for accuflux, but required for the interface.
            river_length: Unused for accuflux, but required for the interface.
            river_beta: Unused for accuflux, but required for the interface.
    ...
    def step(
        ...
        Args:
            ...
            waterbody_storage_m3: Storage of each waterbody in m3.
            outflow_per_waterbody_m3: Outflow of each waterbody in m3.
            river_alpha: The alpha parameter for the kinematic wave equation, which is a 1D array with the same shape as the grid. Not used in this method, but included for consistency with the KinematicWave class.
            river_beta: The beta parameter for the kinematic wave equation, which is a 1D array. Not used in this method, but included for consistency with the KinematicWave class.
        ...
        """
        outflow_at_pits_m3 = (
            self.get_total_storage(Q_prev_m3_s, river_alpha, river_beta)[
                self.is_pit
            ].sum()
    ...
    def get_total_storage(
        self, Q: ArrayFloat32, river_alpha: ArrayFloat32, river_beta: ArrayFloat32
    ) -> ArrayFloat32:
        """Get the total storage of the river network, which is the sum of the available storage in each cell.
...
class Routing(Module):
    ...
    def spinup(self) -> None:
        ...
        # For dynamic alpha and beta, we need the average discharge. Therefore,
    ...
    def step(
        ...
        for hour in range(24):
            ...
            (
                ...
                outflow_per_waterbody_m3=outflow_per_waterbody_m3,
                river_alpha=self.hydrology.grid.var.river_width_alpha,
                river_beta=self.hydrology.grid.var.river_width_beta,
            )
        ...
        if __debug__:
            ...
            river_storage_m3: ArrayFloat32 = self.router.get_total_storage(
                self.grid.var.discharge_in_rivers_m3_s_substep,
                river_alpha=self.grid.var.river_width_alpha,
                river_beta=self.grid.var.river_width_beta,
            )
            balance_check(
                how="sum",
                influxes=[
